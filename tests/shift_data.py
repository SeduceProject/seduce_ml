import unittest
from lib.validation.validation import shift_data, shift_data_ltsm, unscale_input, unscale_output, rescale_input, rescale_output, replace_row_variables, extract_substitutions, collect_substitutions_values, shift_data_ltsm_non_scaled
